        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {plans
            .map((plan, index) => (
              <div
                key={index}
                className={`relative rounded-2xl py-8 px-4 md:p-4 md:py-12 shadow-lg transition-all duration-300 transform hover:scale-105 hover:shadow-2xl ${plan.isPopular
                  ? "bg-yellow-400"
                  ...
                  {plan.name === "Basic" ? (
                    ...
                    <>
                      ...
                      <div className="text-3xl font-bold flex items-center gap-1">
                        ...
                        <span className="text-base max-w-16 font-medium leading-4 text-gray-700">
                          {" "}
                          / year
                        </span>
                      </div>
