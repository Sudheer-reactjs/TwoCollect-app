                ...
                <div className="flex w-full gap-3 mb-12 flex-wrap justify-center lg:justify-between">
                    {steps.map((step) => (
                        <button
                            ...
                            className={`flex flex-col items-center max-w-[30%] lg:max-w-max text-sm md:text-base transition font-medium ${activeStep === step.id ? "" : "text-gray-400 "
                                }`}
                        >
                            <span
                                className={`w-8 h-8 rounded-md flex items-center justify-center mb-2 ${activeStep === step.id
