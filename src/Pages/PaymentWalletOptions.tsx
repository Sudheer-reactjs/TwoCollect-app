        ...
        <>
            <section className="py-8 md:py-14">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center">
                    ...
                    <p className="max-w-xl mx-auto md:text-lg mt-8 md:mt-10">With the TwoCollect Wallet, you stay in full control of your shipping expenses — fast, simple, and transparent.</p>
                    <div className="mt-8">
                        <LoginButton />
                    </div>
                </div>
...
export default PaymentWalletOptions;
