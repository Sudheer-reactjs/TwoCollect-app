...
you a clear breakdown of pricing, transit times, and carrier options.</p>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8  w-full text-center">
                 <a href="authentification" className="cartoon-btn bg-[#a7bd37] inline-block text-white px-10 py-6 rounded-full text-2xl transition-colors duration-200 font-medium">
                    Calculate Rate
                </a>
            </div>
        </section>
