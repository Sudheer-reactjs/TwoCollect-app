import { Globe, Search, ShieldAlert, ShoppingBag, Truck } from "lucide-react";
        ...
        <div className="bg-white shadow-md rounded-xl p-6">
          ...
          <div className="flex gap-3 mb-6 bg-[#f0f4f8] p-2 rounded-md">
            <button
              ...
              className={`flex items-center px-4 py-2 rounded-md text-center justify-center  border border-bluecustom w-full gap-2 ${
                tab === "domestic"
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="flex gap-4">
                ...
                <button
                  onClick={() => setUnit("kg")}
                  className={`px-6 py-2 border border-bluecustom rounded-lg min-w-[71px] ${
                    unit === "kg" ? "bg-bluecustom text-white" : ""
                  }`}
                >
                  KG
                </button>
                <button
                  onClick={() => setUnit("g")}
                  className={`px-6 py-2 border border-bluecustom rounded-lg min-w-[71px] ${
                    unit === "g" ? "bg-bluecustom text-white" : ""
                  }`}
                >
                  G
                </button>
