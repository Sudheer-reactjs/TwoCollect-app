                    ...
                    <div className="w-full flex flex-col gap-5 md:gap-8 text-sm md:text-base">
                        <div className="w-full flex flex-col gap-4">
                            ...
                            <div className="w-full flex flex-col gap-2">
                                ...
                                <p>These Terms and Conditions govern your access to and use of our platform, which includes our website, tools, APIs, and related services. By using our Platform, you agree to abide by these Terms.</p>
                            </div>
                            <div className="w-full flex flex-col gap-2">
                            ...
                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">Acceptance of Terms</h3>
                                <p>By registering, accessing, or using the Platform, you confirm that you have read, understood, and agreed to these Terms, along with our Privacy Policy. If you do not agree with these Terms, you must stop using our Platform and Services immediately.</p>
                            </div>
                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">Authorization for Businesses</h3>
                                <p>If you are using the Platform on behalf of a business or organization, you warrant that you have the authority to
                                    accept these Terms on behalf of that entity</p>
                            </div>

                        </div>

                        <div className="w-full flex flex-col gap-4">
                            <h2 className="text-xl md:text-2xl font-medium">2. Definitions</h2>
                            ...
                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">“Services”</h3>
                                <p>Refers to all features, tools, and functionalities provided by the Platform, including but not limited to:</p>
                                <ul className="list-disc pl-6 space-y-1">
                                    <li>Generating and managing shipping labels</li>
                                    <li>Comparing shipping rates across Service Providers</li>
                                    <li>Real-time tracking and reporting.</li>
                                    <li>Integration with third-party marketplaces or systems.</li>
                                </ul>
                            </div>
                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">“Users”</h3>
                                <p>Refers to any individual, business, or organization that accesses or uses the Platform and Services. Users may include:</p>
                                <ol className="list-decimal  pl-6 space-y-1">
                                    <li><b>Individual Users</b> who manage personal shipments.</li>
                                    <li><b>Business Users</b> who manage shipping for commercial purposes.</li>
                                </ol>
                            </div>
                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">“Service Providers”</h3>
                                <p>Refers to third-party shipping and logistics companies, including but not limited to courier services, freight carriers,
                                    and postal services, that provide shipping solutions through the Platform.</p>
                            </div>
                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">“Account”</h3>
                                <p>Refers to the unique user profile created by Users to access and use the Platform and Services.</p>
                            </div>
                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">“Subscription Fees”</h3>
                                <p>Refers to the recurring charges paid by Users to access the Platform&rsquo;s features and Services.</p>
                            </div>
                            <div className="w-full flex flex-col gap-2">
                            ...
                            <div className="w-full flex flex-col gap-2">
                                ...
                                <p>Refers to these Terms and Conditions, including any updates or amendments, which govern the use of the Platform and Services.</p>
                            </div>
                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">“You” or “Your”</h3>
                                <p>Refers to the User of the Platform, including both individual and business Users</p>
                            </div>
                        </div>
                        ...
                        <div className="w-full flex flex-col gap-4">
                            ...
                            <div className="w-full flex flex-col gap-2">
                                ...
                                <ul className="list-disc pl-6 space-y-1">
                                    <li>Users can generate shipping labels for domestic and international shipments by integrating with multiple third-party Service Providers</li>
                                    <li>Labels include essential details, such as tracking numbers and carrier-specific barcodes, in accordance with the Service Providers&rsquo; requirements.</li>
                                </ul>
                            </div>
                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">3.2. Rate Comparison</h3>
                                <ul className="list-disc pl-6 space-y-1">
                                    <li>The Platform enables Users to compare shipping rates from various Service Providers to find the most costeffective option for their needs.</li>
                                    <li>Rates displayed are provided by the Service Providers and are subject to change based on their terms and conditions.</li>
                                </ul>
                            </div>
                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">3.3. Real-Time Tracking and Notifications</h3>
                                <ul className="list-disc pl-6 space-y-1">
                                    <li>Users can track the status of their shipments through our Platform. Updates are provided directly by the Service Providers.</li>
                                    <li>Notifications about shipment progress, delays, or delivery confirmations are available through the Platform.</li>
                                </ul>
                            </div>
                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">3.4. Integration with Third-Party Systems</h3>
                                <ul className="list-disc pl-6 space-y-1">
                                    <li>The Platform supports integration with third-party marketplaces, e-commerce platforms, and order management systems such as Shopify, WooCommerce and others.</li>
                                    <li>Integrations facilitate seamless order imports, shipping label creation, and tracking updates.</li>
                                </ul>
                            </div>
                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">3.5. Centralized Shipping Management</h3>
                                <ul className="list-disc pl-6 space-y-1">
                                    <li>Users can manage multiple Service Provider accounts in one place, providing a centralized dashboard for all shipping-related activities.</li>
                                </ul>
                            </div>
                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">3.5. Centralized Shipping Management</h3>
                            ...
                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">3.6. Analytics and Reporting</h3>
                                <ul className="list-disc pl-6 space-y-1">
                                    <li>The Platform offers analytics tools that provide insights into shipping costs, delivery performance, and other key metrics to help Users make informed decisions.</li>
                                </ul>
                            </div>
                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">3.7. Customer Support</h3>
                                <ul className="list-disc pl-6 space-y-1">
                                    <li>Our support team is available to assist Users with technical issues, account setup, and general inquiries regarding the Platform.</li>
                                </ul>
                            </div>
                            <div className="w-full flex flex-col gap-2">
                                ...
                                <ol className="list-decimal  pl-6 space-y-1">
                                    ...
                                    <li><b>Availability of Services:</b> Certain features may be subject to availability, geographic restrictions, or additional fees.</li>
                                </ol>
                            </div>
                        ...
                        <div className="w-full flex flex-col gap-4">
                            <h2 className="text-xl md:text-2xl font-medium">4. User Obligations</h2>
                            <p>By accessing and using the Platform, Users agree to the following obligations:</p>

                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">4.1. Accurate Information</h3>
                                <ul className="list-disc pl-6 space-y-1">
                                    <li>Users must provide accurate, complete, and up-to-date information when creating an account or using the Platform.</li>
                                    <li>Users are responsible for ensuring that shipping details (e.g., recipient name, address, contact information) are correct and comply with Service Provider requirements.</li>
                                </ul>
                            </div>
                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">4.2. Compliance with Laws</h3>
                                <ul className="list-disc pl-6 space-y-1">
                                    <li>Users must comply with all applicable UAE laws, including but not limited to customs regulations, import/export controls, and anti-money laundering laws.</li>
                                    <li> Users shall not use the Platform for illegal purposes, including shipping prohibited or restricted items as defined by UAE law or the Service Provider.</li>
                                </ul>
                            </div>
                            <div className="w-full flex flex-col gap-2">
                            ...
                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">4.4. Prohibited Conduct</h3>
                                <p>Users shall not:</p>
                                <ul className="list-disc pl-6 space-y-1">
                                    <li>Use the Platform to engage in fraudulent or deceptive activities.</li>
                                    <li>Upload or transmit harmful content, such as viruses, malware, or any other technology that could harm the Platform or other users</li>
                                    <li>Attempt to gain unauthorized access to the Platform, its systems, or other user accounts.</li>
                                    <li>Abuse or misuse the Platform in a way that interferes with its intended operation or infringes on the rights of others.</li>
                                </ul>
                            </div>
                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">4.5. Payment Obligations</h3>
                                <ul className="list-disc pl-6 space-y-1">
                                    <li>Users are responsible for timely payment of all subscription fees and any additional charges incurred while using the Platform.</li>
                                    <li>Failure to pay subscription fees may result in suspension or termination of access to the Platform.</li>
                                </ul>
                            </div>
                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">4.6. Use of Third-Party Services</h3>
                                <ul className="list-disc pl-6 space-y-1">
                                    <li>Users are responsible for selecting Service Providers and understanding their terms and conditions, including shipping rates, policies, and delivery times.</li>
                                    <li>Users acknowledge that disputes related to shipping services (e.g., delays, damage, or loss) must be resolved directly with the Service Provider.</li>
                                </ul>
                            </div>
                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">4.7. Responsibility for Shipments</h3>
                                <ul className="list-disc pl-6 space-y-1">
                        ...
                        <div className="w-full flex flex-col gap-4">
                            <h2 className="text-xl md:text-2xl font-medium">5. Payment and Subscription Fees</h2>
                            <p>By using the Platform and its Services, Users agree to the following payment terms:</p>

                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">5.1. Subscription Plans</h3>
                                <ul className="list-disc pl-6 space-y-1">
                                    <li>Access to the Platform&rsquo;s features requires Users to subscribe to one of our available subscription plans (“Subscription Fees”).</li>
                                    <li>Details of subscription tiers, pricing, and included features are available on the Platform or during the account registration process.</li>
                                    <li>Subscription Fees are charged on a recurring basis (e.g., monthly, annually) as specified at the time of subscription.</li>
                                </ul>
                            </div>
                            <div className="w-full flex flex-col gap-2">
                            ...
                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">5.3. Automatic Renewal</h3>
                                <ul className="list-disc pl-6 space-y-1">
                                    <li>Subscription plans automatically renew at the end of the billing period unless canceled by the User prior to the renewal date.</li>
                                    <li>By subscribing, Users agree to allow automatic charges for each renewal period using the payment method on file.</li>
                                </ul>
                            </div>
                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">5.4. Non-Refundable Fees</h3>
                                <ul className="list-disc pl-6 space-y-1">
                                    <li>Subscription Fees are non-refundable except as required by law or explicitly stated in our refund policy.</li>
                                    <li>If a User cancels their subscription before the end of the billing period, they will not receive a prorated refund for unused time.</li>
                                </ul>
                            </div>
                            <div className="w-full flex flex-col gap-2">
                            ...
                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">5.6. Currency and Taxes</h3>
                                <ul className="list-disc pl-6 space-y-1">
                                    <li>All Subscription Fees are charged in AED unless otherwise specified.</li>
                                    <li>Applicable taxes, including VAT, will be added to the total charge where required by UAE law.</li>
                                </ul>
                            </div>
                            <div className="w-full flex flex-col gap-2">
                        ...
                        <div className="w-full flex flex-col gap-4">
                            ...
                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">6.1. Data Collection</h3>
                            ...
                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">6.2. Purpose of Data Usage</h3>
                                <p>We use your information for the following purposes:</p>
                                <ul className="list-disc pl-6 space-y-1">
                                    <li>To provide and improve our Services, such as generating shipping labels and integrating with third-party Service Providers.</li>
                                    <li>To process payments and manage subscriptions.</li>
                                    <li>To communicate with you regarding account updates, technical support, and marketing (if consent is provided).</li>
                                ...
                                <ol className="list-decimal pl-6 space-y-1 pt-1">
                                    <li>
                                        ...
                                        <ul className="list-disc pl-6 space-y-1 pt-1">
                                            <li>Shipping information is shared with the selected Service Provider to fulfill shipments.</li></ul>
                                    </li>
                                    <li>
                                        <strong>With Third-Party Partners:</strong>  <ul className="list-disc pl-6 space-y-1 pt-1"> <li>For payment processing and third-party integrations with e-commerce platforms.
                                        </li></ul>
                                    </li>
                                    <li>
                                        <strong>For Legal Compliance:</strong>  <ul className="list-disc pl-6 space-y-1 pt-1"> <li>If required by UAE law or legal processes, such as responding to court orders or regulatory investigations.
                                        </li>
                                        </ul>
                                    </li>
                                </ol>
                            ...
                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">6.4. Data Security</h3>
                                <ul className="list-disc pl-6 space-y-1">
                                    ...
                                    <li>Despite our efforts, no method of electronic storage or transmission is 100% secure. By using the Platform, you acknowledge and accept this inherent risk.</li>
                                </ul>
                            </div>
                            ...
                            <div className="w-full flex flex-col gap-2">
                                ...
                                <ul className="list-decimal pl-6 space-y-1 pt-1">
                                    ...
                                    <li><strong>Objection:</strong> Object to specific data processing activities, such as direct marketing.</li>
                                </ul>
                            </div>

                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">6.8. Updates to Privacy Practices</h3>
                                <p>
                                    We may update our privacy practices from time to time to comply with changes in UAE law or operational needs.
                                    Updates will be reflected in the Privacy Policy, and significant changes will be communicated to you via email or in-app notifications.
                                </p>
                            </div>
                        ...
                        <div className="w-full flex flex-col gap-4">
                            ...
                            <div className="w-full flex flex-col gap-2">
                                ...
                                <ul className="list-disc pl-6 space-y-1"> <li>TwoCollect  is not responsible for the following:
                                    <ul className="list-decimal pl-6 space-y-1 pt-1">
                                        ...
                                        <li>Customs duties, taxes, or import/export restrictions applied to shipments by authorities or Service Providers.</li>
                                    </ul>
                                </li>
                                </ul>
                            </div>
                            ...
                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">7.4. User and Service Provider Relationship</h3>
                                <ul className="list-disc pl-6 space-y-1">
                                    <li>Users enter into a direct contractual relationship with the selected Service Provider for shipping and logistics services.</li>
                                    <li>All terms, conditions, and obligations related to shipping services (e.g., delivery timelines, claims for damage or loss)
                                        are governed by the Service Provider&rsquo;s policies. Users are responsible for understanding and agreeing to these policies
                            ...
                            <div className="w-full flex flex-col gap-2">
                                ...
                                <ul className="list-disc pl-6 space-y-1"><li>TwoCollect  is not liable for any damages, losses, or costs incurred by the User as a result of:
                                    <ul className="list-disc pl-6 space-y-1 pt-1">
                                        ...
                                        <li>Any breach of the Service Provider&rsquo;s obligations under their terms.</li>
                                    </ul>
                                </li>
                                </ul>
                            </div>
                        ...
                        <div className="w-full flex flex-col gap-4">
                            ...
                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">8.1. Platform-Related Disputes</h3>
                                <ul className="list-disc pl-6 space-y-1">
                                    <li>
                            ...
                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">8.2. Service Provider Disputes</h3>
                                <ul className="list-disc pl-6 space-y-1">
                                    <li>
                                        Disputes related to shipping services, including delays, damaged or lost shipments, and incorrect charges,
                            ...
                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">8.3. Escalation of Platform-Related Disputes</h3>
                                <ul className="list-disc pl-6 space-y-1">
                                    <li>
                            ...
                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">8.4. Governing Law and Jurisdiction</h3>
                                <ul className="list-disc pl-6 space-y-1">
                                    <li>Any unresolved disputes will be governed by and interpreted in accordance with the laws of the United Arab Emirates.</li>
                                    <li>Users agree to submit to the exclusive jurisdiction of the courts of Dubai Courts for the resolution of disputes.</li>
                                </ul>
                            </div>
                            ...
                            <div className="w-full flex flex-col gap-2">
                                ...
                                <ul className="list-disc pl-6 space-y-1">
                                    ...
                                    <li>
                                        Costs associated with ADR shall be borne by the parties as agreed or as determined by the arbitrator/mediator.
                                    </li>
                                </ul>
                            </div>

                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">8.6. User Responsibility for Service Provider Issues</h3>
                                <ul className="list-disc pl-6 space-y-1">
                                    <li>
                                        Users are encouraged to familiarize themselves with the terms and conditions of their chosen Service Provider,
                                        including their dispute resolution policies, to avoid misunderstandings or delays in resolving issues.
                                    </li>
                                </ul>
                            </div>

                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">8.7. Timeframe for Dispute Filing</h3>
                                <ul className="list-disc pl-6 space-y-1">
                                    <li>
                                        All disputes related to the Platform or Services must be raised within [insert time limit, e.g., 60 days]
                                        from the date the issue occurred. Failure to raise a dispute within this timeframe may result in the forfeiture
                                        of your right to pursue the matter.
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className="w-full flex flex-col gap-4">
                            ...
                            <div className="w-full flex flex-col gap-2">
                                ...
                                <ul className="list-disc pl-6 space-y-1"><li>TwoCollect  acts solely as an intermediary and is not liable for any actions, omissions, or performance issues of the Service Providers, including but not limited to:
                                    <ol className="list-decimal pl-6 space-y-1 pt-1">
                                        ...
                                        <li>Breaches of any contract or terms between the User and the Service Provider.</li>
                                    </ol>
                                </li>
                                </ul>
                            </div>
                            ...
                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">9.6. User Responsibility</h3>
                                <ul className="list-disc pl-6 space-y-1">
                                    <li>Users are solely responsible for:
                                        <ul className="list-decimal pl-6 space-y-1 pt-1">
                                            <li>Verifying the accuracy of shipment details and shipping rates before confirming a transaction.</li>
                                            <li>Understanding and agreeing to the terms and conditions of the selected Service Provider.</li>
                                            <li>Complying with applicable laws and regulations regarding shipments, including customs, taxes, and import/export requirements.</li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <ul className="list-disc pl-6 space-y-1">
                                    <li>TwoCollect  is not liable for any failure or delay in performance due to circumstances beyond our reasonable control, including but not limited to:
                                        <ul className="list-decimal pl-6 space-y-1 pt-1">
                                            ...
                                            <li>Power outages, internet service disruptions, or cyberattacks.</li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">9.8. Legal Compliance</h3>
                                <ul className="list-disc pl-6 space-y-1">
                                    <li>
                                        Nothing in this section shall exclude liability for fraud, gross negligence, or any other liability that cannot be limited or excluded under applicable UAE law.
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className="w-full flex flex-col gap-4">
                            <h2 className="text-xl md:text-2xl font-medium">10. Intellectual Property</h2>
                                ...
                                <ul className="list-disc pl-6 space-y-1">
                                    ...
                                    <li>Users are prohibited from:
                                        <ol className="list-decimal pl-6 space-y-1 pt-1">
                                            ...
                                            <li>Reverse engineering, decompiling, or disassembling any part of the Platform or its software.</li>
                                            <li>Using Platform Content for commercial purposes without express written permission.</li>
                                        </ol>
                                    </li>
                                ...
                                <ul className="list-disc pl-6 space-y-1">
                                    <li>If you believe that any content on the Platform infringes your intellectual property rights, please contact TwoCollect at [Support Email] with the following details:
                                        <ol className="list-decimal pl-6 space-y-1 pt-1">
                                            ...
                                            <li>A description of the allegedly infringing content and its location on the Platform.</li>
                            ...
                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">10.7. Termination of License</h3>
                                <ul className="list-disc pl-6 space-y-1">
                                    <li>
                                        The limited license granted to Users automatically terminates if they violate these Terms or misuse the Platform Content. Upon termination, Users must cease all use of the Platform and delete any copies of Platform Content in their possession.
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className="w-full flex flex-col gap-4">
                            <h2 className="text-xl md:text-2xl font-medium">11. Modifications</h2>
                            ...
                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">11.3. User Acceptance of Changes</h3>
                                <ul className="list-disc pl-6 space-y-1">
                                    <li>Continued use of the Platform after updates to these Terms constitutes acceptance of the modified Terms. If you do not agree to the changes, you must discontinue use of the Platform immediately.</li>
                                    <li>Users are encouraged to review the Terms periodically to stay informed about any updates.</li>
                                </ul>
                            </div>
                            ...
                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">11.6. No Retroactive Changes</h3>
                                <ul className="list-disc pl-6 space-y-1">
                                    <li>Modifications to these Terms will not retroactively affect rights or obligations arising before the changes were implemented unless required by law.</li>
                                </ul>
                            </div>
                        </div>
                        <div className="w-full flex flex-col gap-4">
                            <h2 className="text-xl md:text-2xl font-medium">12. Termination</h2>

                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">12.1. Termination by the User</h3>
                                <ul className="list-disc pl-6 space-y-1">
                        ...
                        <div className="w-full flex flex-col gap-4">
                            <h2 className="text-xl md:text-2xl font-medium">13. Governing Law and Jurisdiction</h2>

                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">13.1. Governing Law</h3>
                                <ul className="list-disc pl-6 space-y-1">
                                    <li>
                                        These Terms and Conditions, as well as any disputes arising from or in connection with the use of the
                                        Platform or Services, are governed by and construed in accordance with the laws of the United Arab
                                        Emirates.
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">13.2. Jurisdiction</h3>
                                <ul className="list-disc pl-6 space-y-1">
                                    <li>
                                        Any disputes or claims arising under these Terms shall be subject to the exclusive jurisdiction of the courts of
                                        Dubai Courts, unless otherwise required by applicable law.
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">13.4. Alternative Dispute Resolution (Optional)</h3>
                                <ul className="list-disc pl-6 space-y-1">
                                    <li>Where feasible, TwoCollect encourages the resolution of disputes through negotiation or mediation before resorting to formal legal proceedings.</li>
                                    <li>Parties may agree to submit disputes to arbitration in accordance with the rules of [insert relevant arbitration institution, e.g., Dubai International Arbitration Centre (DIAC)], conducted in English and Arabic language. The decision of the arbitrator(s) shall be final and binding.</li>
                                </ul>
                            </div>

                            <div className="w-full flex flex-col gap-2">
                                <h3 className="text-lg md:text-xl font-medium">13.5. Cross-Border Issues</h3>
                                <ul className="list-disc pl-6 space-y-1">
                                    <li>
                                        If you access the Platform from outside the UAE, you are solely responsible for ensuring compliance with the
                                        laws of your jurisdiction and the applicable laws of the UAE.
                                    </li>
                                </ul>
                            </div>
                        </div>
