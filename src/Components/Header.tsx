        ...
        <div className="max-w-[1466px] mx-auto py-4 px-4 sm:px-6 lg:px-8 relative z-5">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden lg:flex items-center space-x-5 z-5">
              <a href="authentification" className="bg-bluecustom text-white px-4 py-2 rounded-full hover:bg-bluecustomhover transition-colors duration-200 font-medium">
                START FOR FREE
              </a>
          ...
          <div className="md:hidden bg-white border-t border-gray-100 relative z-30">
            <div className="px-4 py-8 ">
              ...
              <div className="flex flex-col justify-center items-center space-y-2">
                <a href="authentification" className="bg-bluecustom  text-[14px] text-white px-4 py-3 rounded-full text-center w-full hover:bg-bluecustomhover transition-colors duration-200 font-medium">
                  START FOR FREE
                </a>
                <p className="text-xs">or</p>
